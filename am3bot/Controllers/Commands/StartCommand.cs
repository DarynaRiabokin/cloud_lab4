...
namespace am3bot.Controllers.Commands
{
    public class StartCommand : ICommand
    {
        ...
        private ReplyKeyboardMarkup GetChessboardMainMenuKeyboard()
        {
            ...
            {
        new KeyboardButton[] { new KeyboardButton("Спеціальності🧑🏿‍🎓"), new KeyboardButton("Освітні програми🏫"), new KeyboardButton("Військова кафедра🎖️") },
        new KeyboardButton[] { new KeyboardButton("Як добратися🗺️"), new KeyboardButton("Офіційний сайт🌏") },
